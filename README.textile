...
Rails 5.0 example application that provides user management, authentication, and simple role-based authorization. The application uses:
...
<pre>
$ git clone https://github.com/shaik1729/on-service.git
</pre>
